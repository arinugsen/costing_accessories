...
def get_pairs_meter(sr1, sr2, no1, no2):
	...
	# data = frappe.db.get_list('Raw Material Consumption', 
	# 	filters=[[
	...
	for x, y in data:
		...
		qty_foam_cup_per_m_prs = frappe.db.get_value('Raw Material Consumption', {'size':size}, 'qty_foam_cup_per_m_prs')
	...
	# qty_foam_cup_per_m_prs = frappe.db.get_value('Raw Material Consumption', {'size':sr1}, 'qty_foam_cup_per_m_prs')
